...
#if defined(NDEBUG)
# error "Cryptocoin24 cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0xd78834faec913dd4f198cee95e4b068e0399b88d0c2e6c49adbbaaeb63d40720");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Cryptocoin24: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Cryptocoin24 Signed Message:\n";
...
{
    // Cryptocoin24: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Cryptocoin24: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Cryptocoin24: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1502456712, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "Kuwait announces measures against North Korea";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 250 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("043e3d765c3c1c9a71148fc58f957a740a82cb856a6089cc64860e248f9e5cb765d678400a09815f48ac6aaf2700e6de87eaf5be475b083420cc54185d2891c353") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1502456712;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 3668340;
        ...
        assert(block.hashMerkleRoot == uint256("0xa17dfb492bf4ab012c0bdd4af116e07f040bcfc4e5d07f09ad93586beeba34e4"));
...
unsigned char pchMessageStart[4] = { 0x10, 0xd3, 0xdb, 0x78 }; // Cryptocoin24: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("Cryptocoin24Miner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("Cryptocoin24Miner : ProcessBlock, block not accepted");
    }

    return true;
}

void static Cryptocoin24Miner(CWallet *pwallet)
{
    printf("Cryptocoin24Miner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("cryptocoin24-miner");
    ...
    try { loop {
        ...
        printf("Running Cryptocoin24Miner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("Cryptocoin24Miner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&Cryptocoin24Miner, pwallet));
}
