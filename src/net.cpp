...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Cryptocoin24 " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"cryptocoin24.org", "node1.cryptocoin24.org"},
    {"cryptocoin24.org", "node2.cryptocoin24.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Cryptocoin24 is probably already running."), addrBind.ToString().c_str());
        else
